...
typedef void     (*CO_IF_NVM_INIT_FUNC )(CO_PENGUIN_CAN_POINTER_TYPE);
typedef uint32_t (*CO_IF_NVM_READ_FUNC )(CO_PENGUIN_CAN_POINTER_TYPE, uint32_t, uint8_t *, uint32_t);
typedef uint32_t (*CO_IF_NVM_WRITE_FUNC)(CO_PENGUIN_CAN_POINTER_TYPE, uint32_t, uint8_t *, uint32_t);
